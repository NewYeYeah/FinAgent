...
export const defaultPanelRegistry = new PanelRegistry([
  ...
  { panel_id: "factors", module: "factors", title: "Factors", route: "/factors", status: "available", context_keys: ["program_id", "factor_id", "date_range", "session_date", "fold_id"], slot: "chart" },
