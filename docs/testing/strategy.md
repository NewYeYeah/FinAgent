...
The frontend CI/developer runtime currently uses Node 22 until ENG-0 explicitly changes it.

## 3. Data-stage acceptance
...
## 5. Statistical research acceptance
...
## 8. Historical A-share release reproduction
