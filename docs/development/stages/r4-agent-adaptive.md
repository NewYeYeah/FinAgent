...
Implemented: causal MarketState/FactorLibrary, five deterministic allocator baselines, session walk-forward evidence, bounded Agent Research Controller, a thin Research Console, the matched-campaign protocol/runner with the Primary reachability correction, and a guarded real campaign execution operator. A real matched-budget campaign, accepted AdaptiveStrategy and the R4 terminal remain pending; B-005 provider admission stays open.
